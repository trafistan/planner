...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let mut client = Client::connect(
        "host=tf-2025081018303032650000000a.cluster-c1y2k8e8uxdb.eu-central-1.rds.amazonaws.com user=postgres password=wV[P(.QW]4S_iAkT)1E8X(W<J.3Q dbname=db", NoTls)?;
